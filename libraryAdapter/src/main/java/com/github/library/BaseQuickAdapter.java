...
import com.github.library.listener.LoaderMoreListener;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    private LoaderMoreListener mLoaderMoreListener;

    public void setLoaderMoreListener(LoaderMoreListener loaderMoreListener) {
        mLoaderMoreListener = loaderMoreListener;
    }
    ...
    private K getLoadingView(ViewGroup parent) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(mLoaderMoreListener != null){
                    mLoaderMoreListener.loaderMore();
                }
            }
        });
        return holder;
